# Introduction
This repository contains research and implementation of various smoothing techniques applied to rate-normalized pressure (RNP) data to improve trend detection in rate-transient analysis (RTA). Our study evaluates the effectiveness of these methods in identifying underlying patterns and improving the accuracy of critical metrics such as flow-regime times and reservoir characteristics.

# Highlights
- Comparison of Five Smoothing Methods: Evaluating their performance based on the sum of square errors (SSE).
- Optimization of linear GAM Parameters: Identifying the optimal window size and its impact on noise reduction.
